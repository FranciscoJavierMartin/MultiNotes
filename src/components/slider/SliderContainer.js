...
const enhancer = compose(
    ...
    withHandlers({
        setValue: props => props.currentValue.setValue(nextValue),
        ...
        getValueFromEvent: props => (e) => {
            const value = (e.nativeEvent.locationX / props.width) * props.maximumValue;
            return Math.max(
                props.minumumValue,
                Math.min(
                    props.maximumValue,
        ...
        getThumbLeft: props => (value) => {
            ...
            return ratio*(props.width - props.thumbSize);
        },
    }),
    withHandlers({
        handleMoveShouldSetPanResponder: props => () => true,
        ...
        handlerPanResponderRequestEnd: props => () => true,
        ...
        handleStartShouldSetPanResponder: props => (e) => true,
    }),
    withPropsOnChange(
        ['value'],
    ...
    withProps(props => ({
        thumbLeft: props.currentValue.interpolate({
            inputRange: [props.minumumValue, props.maximumValue],
