...
const AudioPlayerView = ({
    ...
    if(isLoading){
        ...
        <View style={styles.container}>
            <TouchableOpacity style={styles.button} onPress={onTogglePlaying}>
                <Icon size={28} IconSet={Feather} iconName={isPlaying ? 'pause' : 'play'}
                    iconStyle={styles.playIcon} color={colors.white}/>
            </TouchableOpacity>
