...
const VideoItem = ({
    ...
    return (
        <TouchableHighlight onPress={() => onPress && onPress(item)}
            style={[globalStyles.withWitheBackground,s.container]}>
            <View style={[globalStyles.withWitheBackground,s.contentContainer]}>
                <View style={s.header}>
                    <Icon size={70} IconSet={Entypo} iconName="video" color="#00a086"/>
                </View>
